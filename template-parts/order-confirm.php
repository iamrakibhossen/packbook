...
<div class="row font-weight-bold">
    ...
    <div class="col-md-4">
        ...
        <h5 class="mb-0 ml-4 h6 font-weight-normal"><span class="font-weight-bold">Trancking</span> - <?php echo $way_bill; ?></h5>
