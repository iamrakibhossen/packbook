...
$term = get_term_by('id', $term_id, 'faq_cat');
            ...
            <div class="col-md-3 font-weight-bold mb-3">
                ...
                <div class="nav flex-column nav-pills">
                    ...
                    <?php foreach ($cats as $cat) { ?>
                        <a class="nav-link py-2 <?php if ($term_id == $cat->term_id) echo 'active'; ?>" href="<?php echo get_term_link($cat); ?>"><?php echo $cat->name; ?></a>
                    <?php } ?>
                ...
                <div class="tab-content">
                    <div class="text-lg">
                        ...
                        <?php foreach ($faqs as $faq) { ?>
                            <div class="py-2">
                                <a href="<?php echo get_permalink($faq->ID); ?>"><?php echo $faq->post_title; ?></a>
                            </div>
                        <?php } ?>
                    </div>
