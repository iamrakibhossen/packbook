                        ...
                        <td style="border: 0;border-collapse: collapse;margin: 0;padding: 0;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;height: 285mm"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="border: 1px solid#a5a5a5; padding: 10px; font-weight: bold; background:#e7e6e6"
                                            ...
                                            <b>Faktura nr 0000001/IF/2021</b></td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        <td align="left" valign="bottom" width="50%">
                                            <p><b>Data sprzedaży: 03.31.2021</b></p>
                                            <p><b>Termin płatności: Zapłacone</b></p>
                                        </td>
                                        <td align="right" valign="bottom" width="50%">
                                            <p><b>Data wystawienia: 03.31.2021</b></p>
                                            <p><b>Metoda płatności: Stripe</b></p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        <td align="left" valign="bottom" width="100%"
                                            style="height: 20px; background:#e7e6e6"></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table dir="ltr" width="90%"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="left" valign="bottom"
                                            style="font-weight: bold;background: #f6f9fc; padding: 10px 15px; font-size: 12px">
                                            1.</td>
                                        <td align="center" valign="bottom"
                                            style=" width: 200px; font-weight: bold;background: #f6f9fc; padding: 10px 15px; font-size: 12px">
                                            Usługa kurierska <br /> ( ID: 0000001)</td>
                                        <td align="right" valign="bottom"
                                            style="font-weight: bold;background: #f6f9fc; padding: 10px 15px; font-size: 12px">
                                            Szt</td>
                                        <td align="left" valign="bottom"
                                ...
                                <tbody>
                                    <tr>
                                        <td align="right" valign="bottom" width="100%" style="">
                                            <p>Zapłacono: 17.00 PLN</p>
                                            <p>Pozostało: 0.00 PLN</p>
                                            <p><b>Razem: 17.00 PLN</b></p>
